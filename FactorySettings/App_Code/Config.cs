...
namespace Listener.App_Code
{
    ...
    public static class Config
    {
        ...
        /// 充电监控tcp有效客户端队列
        /// </summary>
        public static Dictionary<string, Dictionary<string, object>> g_tcpClientDic = new Dictionary<string, Dictionary<string, object>>();
        /// <summary>
        /// 充电监控tcp有效客户端队列（充电站）
        /// </summary>
        public static Dictionary<string, Dictionary<string, object>> g_tcpCSClientDic = new Dictionary<string, Dictionary<string, object>>();
        /// <summary>
        /// 充电监控充电桩数据列表
        /// </summary>
        public static ObservableCollection<Listener_ChargeStation_Data> g_dataList = new ObservableCollection<Listener_ChargeStation_Data>();
        /// <summary>
        /// 设备报警
        /// </summary>
